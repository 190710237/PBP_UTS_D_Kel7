...
public class Materi {
    ...
    public static final String PerkalianSilang = "     Perkalian matriks adalah sebuah operasi perkalian antara dua atau lebih matriks yang memiliki cara aturan tertentu.";
